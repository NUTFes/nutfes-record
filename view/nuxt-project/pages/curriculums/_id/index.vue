<template>
  <div>
          ...
          <b-tab title="Record" active>
            <b-card-text v-if="user.role_id==1">
              <div v-for="t_record in teacher_records">
                ...
                <br>
                <p style="text-align:right">{{ t_record.updated_at | format-date }}</p>
                <hr>
              </div>
            </b-card-text>
            <b-card-text v-if="user.role_id==2">
              <div v-for="record in records" :key="record.id">
                ...
                <br>
                <p style="text-align:right">{{ record.updated_at | format-date }}</p>
                <hr>
              </div>
            </b-card-text>
          </b-tab>
    ...
    <b-row>
      <b-col cols=3></b-col>
      <b-col>
        <b-button to="/curriculums">Back</b-button>
